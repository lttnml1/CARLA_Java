...
def execute_scenario(args, adversary_target_speed):
    ...
    try:
        ...
        #adversary_spawn_point = carla.Transform(carla.Location(x=-88.668266, y=5.793464, z=0.275),carla.Rotation(roll=0,pitch=0,yaw=-160))
        ...
        adv_agent = SimpleAgent(adv, adv_destination, target_speed = (adversary_target_speed))
