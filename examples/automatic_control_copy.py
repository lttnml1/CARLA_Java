...
class World(object):
    ...
    def restart(self, args):
        ...
        """
        blueprint=self.world.get_blueprint_library().filter("diamondback")[0]
...
def game_loop(args):
    ...
    try:
        ...
        agent = SimpleAgent(world.player, destination)
        ...
        while True:
            ...
            if agent.done():
                if args.loop:
                    agent.set_destination(random.choice(destination_array))
