    ...
    try:
        ...
        for dirName, subdirList, fileList in os.walk(path):
            ...
            for fileName in fileList:
                ...
                call_string3 = "C:/Users/m.litton_local/anaconda3/envs/carla_windows/python.exe c:/Users/m.litton_local/CARLA_Java/examples/Adversary.py --port " + str(args.port) + " --file " + path + fileName
